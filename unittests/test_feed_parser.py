...
from parsers.feed_parser import parse_feed_title, title_compare
...
class TestFeedParser(TestCase):
    ...
    def test_name_parsing(self):
        ...
        self.assertEqual(parse_feed_title(title1),
                         ('11',
                          'FFA',
        ...
        title2 = "[Judas] Re:Zero kara Hajimeru Isekai Seikatsu - S02E11 [1080p][HEVC x265 10bit][Multi-Subs] (Weekly)"
        self.assertEqual(parse_feed_title(title2),
                         ('11',
                          'Judas',
                          'Re:Zero kara Hajimeru Isekai Seikatsu - S02',
                          1080,
                          'mkv'))
